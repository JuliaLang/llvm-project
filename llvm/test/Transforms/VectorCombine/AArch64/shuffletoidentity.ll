...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <2 x i64> [[TMP2:%.*]], <2 x i64> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 1>
; CHECK-NEXT:    [[CONV:%.*]] = trunc <4 x i64> [[SHUFFLE]] to <4 x i16>
; CHECK-NEXT:    [[TMP4:%.*]] = trunc <2 x i64> [[TMP2]] to <2 x i16>
; CHECK-NEXT:    [[TMP5:%.*]] = shufflevector <4 x i16> [[CONV]], <4 x i16> poison, <2 x i32> <i32 2, i32 2>
; CHECK-NEXT:    [[SHUFFLE_I:%.*]] = sub <2 x i16> [[TMP4]], [[TMP5]]
